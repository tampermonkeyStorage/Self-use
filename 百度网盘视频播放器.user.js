...
(function() {
    ...
    obj.unlockVideoLimit = function () {
        obj.async("file-widget-1:videoPlay/context.js", function(c) {
            unsafeWindow.locals.set("is_svip", 1);
            unsafeWindow.locals.set("vip_level", 2);
            obj.require("system-core:context/context.js").instanceForSystem.message.callSystem("share-video-after-transfer");

            var waitId = setInterval(function() {
                var context = c.getContext() || {}, playerInstance = context.playerInstance;
                if (playerInstance) {
                    clearInterval(waitId);
                    if (playerInstance.userInfo.isSVip) {
                        obj.msg("解锁 视频 SVIP 成功");
                    }
                }
            }, 500);
        });
    ...
    obj.dPlayerStart = function () {
        ...
        try {
            ...
            unsafeWindow.locals.get("file_list") && obj.jQuery()(dPlayerNode).nextAll().remove();
            obj.resetPlayer();
    ...
    obj.run = function () {
        if (obj.video_page.playerPreference != "DPlayer") {
